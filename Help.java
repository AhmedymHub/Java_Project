...
public class Help {
    ...
    public static void main(String[] args) {
        ...
        mainPanel.setBackground(new Color(11, 34, 50)); 

        // Create panels for each section
        JPanel bookPanel = createSectionPanel("TRAVEL INFO", new String[]{
                "Check-in info",
                "Baggage services",
                "Sports equipment",
        ...
        JPanel managePanel = createSectionPanel("FAQ", new String[]{
                "Manage booking",
                "Check-in",
                "Flight status"
        });

        JPanel servicesPanel = createSectionPanel("HELP CENTER", new String[]{
                "Seat selection",
                "Extra baggage",
                "Traveling with pets",
